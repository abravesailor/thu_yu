...
def msglist_ajax(request):
    ...
    try:
        ...
        for msg in messages:
            ...
            tmp_dict['create_time']=datetime.datetime.strptime(msg.create_time, "%Y-%m-%d %H:%M").strftime("%Y-%m-%d %H:%M")
...
def group_add(request):
    ...
    try:
        ...
        new_group=Group(group_id=str(group_id),lessons=lessons)
